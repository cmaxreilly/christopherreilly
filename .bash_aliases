...
alias cblind='bash ~/.bash_scripts/colorblind.sh'
...
alias hgit='bash ~/.bash_scripts/hgit.sh'
...
alias jake='bash ~/.bash_scripts/jake.sh'
...
alias miranda="bash ~/.bash_scripts/miranda.sh"
...
alias ragit='bash ~/.bash_scripts/ragit.sh'
